...
{{-- <div class="col-md-12"> --}}
    ...
    <div class=row style="clear: both;">
        <div class="col-md-3" style="height:20px; width: 230px; margin-left:35px;">
        ...
        <div class="col-md-4" style="height:20px; padding-left:82px;">
            <h5 style="font-size:11px; margin-top:5px">LINGKUNGAN NOMOR : {{$data_jemaat->id_lingkungan}} {{$data_jemaat->lingkungan->nama_lingkungan}}</h5> <br>
        </div>
    </div>
    <div class="row" style="clear: both;">
        <div class="col-md-3" style="height:20px; width: 230px; margin-left:35px;">
        ...
        <div class="col-md-3" style="height:20px; width: 400px;  padding-left:1px;">
    ...
    <div class="row" style="font-size:11px; clear:left">
        ...
        <div class="col-md-3" style="text-align:center;">SNK Drs. ELYSATI NAZARA, MM.</div>
        <div class="col-md-3" style="text-align:center;">SNK TALIFAUDU TELAUMBANUA</div>
    </div>
    </div>              
{{-- </div> --}}
</body>
