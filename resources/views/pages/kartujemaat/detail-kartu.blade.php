...
<div class="col-md-12">
    ...
    <table class="table table-bordered">
        <tbody>
            ...
            <div class=row>
                <div class="col-md-3" style="height:20px; padding-left:42px;">
                    <h5>NAMA KEPALA KELUARGA </h5> <br>
                </div>
                <div class="col-md-4" style="height:20px; padding-left:1px;">
                    <h5>: {{$data_jemaat->jemaat_nama}} </h5> <br>
                </div>
                <div class="col-md-2" style="height:20px;">
                    <h5>LINGKUNGAN NOMOR</h5> <br>
                </div>
                <div class="col-md-3" style="height:20px;">
                    <h5>: {{$data_jemaat->id_lingkungan}} {{$data_jemaat->lingkungan->nama_lingkungan}}</h5> <br>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3" style="height:45px; padding-left:42px;">
                    <h5>ALAMAT LENGKAP/DESA/LURAH</h5> <br>
                </div>
                <div class="col-md-4" style="height:45px; padding-left:1px;">
                    <h5>: {{$data_jemaat->jemaat_alamat_rumah}}</h5> <br>
                </div>
                <div class="col-md-2" style="height:45px;">
                    <h5>SNK Lingkungan</h5> <br>
                </div>
                <div class="col-md-3" style="height:45px;">
                    <h5>: {{$data_jemaat->lingkungan->nama_snk}}</h5> <br>
                </div>
            </div>
