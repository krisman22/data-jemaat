                            ...
                            <table id="table" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span style="font-size:10pt" class="label label-warning">{{$datajemaat->riwayatinaktif->jemaat_keterangan_status}}</span>
                                        </td>
                                        <td>{{ Carbon\Carbon::parse($datajemaat->riwayatinaktif->jemaat_tanggal_status)->isoFormat('dddd, D MMMM Y') }}</td>
                                        <td>@if ($datajemaat->riwayatinaktif->jemaat_tanggal_dikebumikan != null)
                                                {{ Carbon\Carbon::parse($datajemaat->riwayatinaktif->jemaat_tanggal_dikebumikan)->isoFormat('dddd, D MMMM Y') }}
                                            @endif
                                        </td>
